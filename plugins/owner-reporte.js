const handler = async (m, {conn, text, usedPrefix, command}) => {
 ...
 conn.reply('5215629885039@s.whatsapp.net', m.quoted ? teks + m.quoted.text : teks, null, {contextInfo: {mentionedJid: [m.sender]}});
 conn.reply('5217971532324@s.whatsapp.net', m.quoted ? teks + m.quoted.text : teks, null, {contextInfo: {mentionedJid: [m.sender]}});
